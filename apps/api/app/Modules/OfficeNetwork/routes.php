...
use App\Modules\OfficeNetwork\Http\Controllers\ReviewController;
...
Route::get('/offices/{id}/reviews', [ReviewController::class, 'index']);
Route::get('/offices/{id}', [OfficeController::class, 'show']);

// Authenticated citizen appointment & review endpoints
